...
void generate_rand(int x, int y , float w[6][18]){
    srand(time(NULL));
    int i,j;
    float r;
    for(i=0;i<x;i++){
...
void generate_rand2(int x, int y , float w[11][6]){
    srand(time(NULL));
    int i,j;
    float r;
    for(i=0;i<x;i++){
...
void get_act(float act_fun1[6],int n,float input[17], float w[6][18],int x, int y,float fnet[5]){
    int i,j;
    float hidden[n];
    for(i=0;i<x;i++){
        hidden[i]=0.0;
...
void get_act2(float act_fun2[10],int n,float input[5], float w[11][6],int x, int y,float fnet[10]){
    int i,j;
    float hidden[n];
    for(i=0;i<x;i++){
        hidden[i]=0.0;
...
float multi_layer(int original_class,float act_fun2[5],float act_fun1[10],float w[6][18],float w2[11][6],float fnet[10],float input[17],float fnet1[5],float j_w[10],float delta[10],float delta1[5]){
    int j,k;
    float dw;
...
void func1(){
    ...
    int i,j,x=1,flag=0;
    float input[17];
    float w[6][18],r,act_fun1[5],w2[11][6],act_fun2[10],fnet_1[5],fnet_2[10],delta[10],delta1[5];
    FILE *fp;
    input[0]=1.0;
    generate_rand(5,17,w);
    generate_rand2(10,5,w2);
    ...
    while(1){
        ...
        get_act(act_fun1,5,input,w,5,17,fnet_1);
        get_act2(act_fun2,10,act_fun1,w2,10,5,fnet_2);
	int i,j,t_mat[11],k;
        float j_w[10];
        float sum=0.0;
        for(i=0;i<10;i++){
   ...
   //Testing...
    ...
    int testclass[10000],testclass1[10000],k1=0,k2=0;
        ...
        get_act(second,5,minput,w,5,17,fnet_1);
        get_act2(final,10,second,w2,10,5,fnet_2);
